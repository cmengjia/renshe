<template>
    <div class="record-panel" :style="{height: wrapperHeight + 'px'}">
        ...
        <dl class="attence-detail">
            <dt>情况说明</dt>
            <dd><i class="jcm-arrows" v-if="!information.message"></i>
...
<script>
    ...
    export default {
        mounted() {
            ...
            _this.queryCache = {};
            //查询当月考勤记录
            _this.getData(_this.calendar.today[0], _this.calendar.today[1])
        },
        components: {Calendar},
        data() {
            let _this = this;
        ...
        methods: {
            getData(y, m) {
                ...
                if (!_this.queryCache[y + '-' + m]) {
                    _this.queryCache[y + '-' + m] = true;
